        ...
        case 15:
            if (on_level(&u.uz, &qstart_level))
                You_feel(
                    ...
                    (uflags.female || (Upolyd && is_neuter(youmonst.data)))
                        ? "oddly "
                        : "");
            else
